...
### Fits + Striped ->
python3 $DIR/generate_scripts.py -S -b $BB -p 1 -w $PIPELINE -r $AVG -t $TIME -q $QUEUE -c $FILES -z -s
python3 $DIR/generate_scripts.py -S -b $BB -p 4 -w $PIPELINE -r $AVG -t $TIME -q $QUEUE -c $FILES -z -s
python3 $DIR/generate_scripts.py -S -b $BB -p 8 -w $PIPELINE -r $AVG -t $TIME -q $QUEUE -c $FILES -z -s
python3 $DIR/generate_scripts.py -S -b $BB -p 16 -w $PIPELINE -r $AVG -t $TIME -q $QUEUE -c $FILES -z -s
python3 $DIR/generate_scripts.py -S -b $BB -p 32 -w $PIPELINE -r $AVG -t $TIME -q $QUEUE -c $FILES -z -s
